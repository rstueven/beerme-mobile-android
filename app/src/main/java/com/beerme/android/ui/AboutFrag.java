...
public class AboutFrag extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		// TODO: GooglePlayServicesUtil.getOpenSourceSoftwareLicenseInfo()
		View view = inflater.inflate(R.layout.about, container);
		this.getDialog().setTitle(R.string.About);

		TextView appversion = (TextView) view
				.findViewById(R.id.about_appversion);
		appversion.setText("Version: " + Utils.getAppVersion());

		TextView platformversion = (TextView) view
				.findViewById(R.id.about_platformversion);
		...
		contact.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				StringBuffer buf = new StringBuffer(
						getString(R.string.Notes_for_beerMe_support));
				buf.append("\n-------------------------");
