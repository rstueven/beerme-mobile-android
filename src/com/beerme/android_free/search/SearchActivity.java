...
import com.beerme.android_free.ui.BreweryListActivity;
import com.beerme.android_free.ui.MapFactory;
...
public class SearchActivity extends BeerMeActionBarActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCursorAdapter = new SimpleCursorAdapter(getBaseContext(),
				R.layout.suggestions_row, null, new String[] {
						SearchManager.SUGGEST_COLUMN_TEXT_1,
						SearchManager.SUGGEST_COLUMN_TEXT_2 }, new int[] {
						R.id.suggestion_value, R.id.suggestion_detail }, 0);
	...
	private void launchMap(String latLngString) {
		...
		LatLng latLng = new LatLng(Double.parseDouble(latLngArray[0]),
		...
		if (!className.equals("com.beerme.android_free.ui.BeerMeMapActivity")) {
	...
	private void doSearch(String query) {
		...
		mgr.restartLoader(loaderId, args, this);
	}
	...
	private void handleIntent(Intent intent) {
		...
		if (action.equals(Intent.ACTION_VIEW)) {
			...
			Log.w(Utils.APPTAG, "SearchActivity.handleIntent(): WTF ACTION:"
					+ action);
		}
	}
}